...
import yoga from './Banner/Yoga 02.png';
        ...
        <div class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            ...
            <div class="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="hero-text col-span-6">
                    <h1  class=" font-bold text-4xl md:text-4xl max-w-xl text-gray-900 leading-tight mb-2">Welcome to <br/> </h1>
                    <span style={{ fontFamily: 'playfair-display'}} class="text-blue-700 font-bold text-5xl md:text-6xl max-w-xl text-gray-900 leading-tight">Yoga Studio</span> 
                    <hr class=" w-12 h-1 bg-orange-500 rounded-full mt-8" />
                    <p  class="text-gray-800 text-md leading-relaxed font-semibold">Yoga has always been something more, than just a workout routine. It's more of a philosophy, a lifestyle for a mind & body balance.</p>
                    <div class="get-app flex space-x-5 mt-10 justify-center md:justify-start">
                        <button class="apple bg-white shadow-md px-4 py-2 rounded-lg flex items-center space-x-4">
                            <div class="logo">
                                <svg 
                                    class="w-7 h-7"
                            ...
                            <div class="text">
                                <p class=" text-md text-gray-900" style={{fontSize: '0.55rem'}}>Download on the</p>
                                <p class=" text-base font-semibold text-gray-900">Apple Store</p>
                            </div>
                        </button>
                        <button class="google bg-white shadow-md px-4 py-2 rounded-lg flex items-center space-x-4">
                            <div class="image">
                                <svg 
                                    class="w-7 h-7"
                                    xmlns="http://www.w3.org/2000/svg" 
                            ...
                            <div class="text">
                                <p class="text-md text-gray-900" style={{fontSize: '0.55rem'}}>Download it from</p>
                ...
                <div className="hero-image col-span-6 ">
                    <img className='h-full w-full' src={yoga} alt="yoga-banner" />
                </div>
            </div>
        </div>
    </div>
